...
const EngagementChat = ({ onNavigate }: { onNavigate: (view: View) => void }) => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Save intention for ChatInterface
    ...
    <div className="max-w-7xl mx-auto animate-in fade-in duration-700 pb-20">
        ...
        <div className="pt-16 lg:pt-24 pb-8 text-center relative overflow-hidden">
             ...
             <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-8 leading-tight">
                ...
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-pink-500 to-purple-600 dark:from-purple-400 dark:via-pink-300 dark:to-purple-400 bg-[length:200%_auto] animate-shimmer">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-8">
            ...
            />
             <FeatureCard 
                ...
                description="Analyze video content and extract key insights with Zee Vision."
                icon={BrainCircuit}
                color="bg-indigo-600"
                onClick={() => onNavigate(View.CHAT)}
            />
        ...
        {/* Footer / Tech Section */}
        <div className="mt-32 pt-12 border-t border-gray-200 dark:border-slate-800">
